...
<head>
  <?php includeFileWithVariables('layouts/title-meta.php', array('title' => 'Data')); ?>
...
<?php include 'layouts/menu.php'; ?>
  ...
  <main class="main-wrapper">
    <div class="main-content">
      <!--breadcrumb-->
      <?php includeFileWithVariables('layouts/page-title.php', array('title' => 'Widgets', 'pagetitle' => 'Data')); ?>
                ...
                <div class="col">
                  <div class="card shadow-none border rounded-3 mb-0">
                    <div class="card-body">
                      ...
                      <div class="d-flex align-items-center justify-content-end gap-1 text-success mt-3">
                        <p class="mb-0">25.6%</p>
                ...
                <div class="col">
                  <div class="card shadow-none border rounded-3 mb-0">
                    <div class="card-body">
                      ...
                      <div class="d-flex align-items-center justify-content-end gap-1 text-danger mt-3">
                        <p class="mb-0">25.6%</p>
                        <span class="material-icons-outlined fs-6">south</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="card-body">
              <div class="d-flex align-items-start justify-content-between">
                <div class="d-flex align-items-center gap-3 flex-grow-1">
                  <div
                    class="wh-48 d-flex align-items-center bg-primary bg-opacity-10 justify-content-center rounded-circle">
          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex align-items-start justify-content-between">
                <div class="d-flex align-items-center gap-3 flex-grow-1">
                  <div
                    class="wh-48 d-flex align-items-center bg-danger bg-opacity-10 justify-content-center rounded-circle">
          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex align-items-start justify-content-between">
                <div class="d-flex align-items-center gap-3 flex-grow-1">
                  <div
                    class="wh-48 d-flex align-items-center bg-success bg-opacity-10 justify-content-center rounded-circle">
        ...
        <div class="col-12 col-lg-6 col-xl-3">
          <div class="card">
            <div class="card-body">
              <div class="d-flex align-items-start justify-content-between">
                <div class="d-flex align-items-center gap-3 flex-grow-1">
                  <div class="wh-48 d-flex align-items-center bg-orange-light justify-content-center rounded-circle">
          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex flex-column align-items-center gap-2">
                <div class="wh-48 d-flex align-items-center justify-content-center border rounded-circle">
                  <span class="material-icons-outlined">trending_up</span>
                </div>
                <h5 class="mb-0 fw-light">Visitors Growth</h5>
              </div>
              ...
              <div class="d-flex flex-column gap-3">
                <div class="">
                  ...
                  <div class="progress" style="height: 5px;">
                    <div class="progress-bar bg-voilet" style="width: 65%"></div>
                  </div>
                </div>
                <div class="">
          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex align-items-center justify-content-around flex-wrap gap-4 p-4">
                <div class="d-flex flex-column align-items-center justify-content-center gap-2">
                  <a href="javascript:;" class="wh-48 bg-primary bg-opacity-10 text-primary rounded-circle d-flex align-items-center justify-content-center">
                ...
                <div class="vr"></div>
                <div class="d-flex flex-column align-items-center justify-content-center gap-2">
                  <a href="javascript:;" class="wh-48 bg-success bg-opacity-10 text-success rounded-circle d-flex align-items-center justify-content-center">
                ...
                <div class="vr"></div>
                <div class="d-flex flex-column align-items-center justify-content-center gap-2">
                  <a href="javascript:;" class="wh-48 bg-danger bg-opacity-10 text-danger rounded-circle d-flex align-items-center justify-content-center">
                ...
                <div class="vr"></div>
                <div class="d-flex flex-column align-items-center justify-content-center gap-2">
                  <a href="javascript:;" class="wh-48 bg-orange-light bg-opacity-10 text-orange rounded-circle d-flex align-items-center justify-content-center">
                ...
                <div class="vr"></div>
                <div class="d-flex flex-column align-items-center justify-content-center gap-2">
                  <a href="javascript:;" class="wh-48 bg-secondary bg-opacity-10 text-secondary rounded-circle d-flex align-items-center justify-content-center">
                ...
                <div class="vr"></div>
                <div class="d-flex flex-column align-items-center justify-content-center gap-2">
                  <a href="javascript:;" class="wh-48 bg-info bg-opacity-10 text-info rounded-circle d-flex align-items-center justify-content-center">
          ...
          <div class="card">
            <div class="card-body p-4">
              <div class="d-flex align-items-center justify-content-between gap-3 mb-4">
                <div class="">
                  <h4 class="mb-0">$24,589</h4>
                  <p class="mb-0">Total Sales</p>
                </div>
                <div class="wh-48 d-flex bg-voilet text-white bg-opacity-10 align-items-center justify-content-center rounded-circle">
        ...
        <div class="col-12 col-xl-4 d-flex">
          <div class="card overflow-hidden w-100">
            <div class="p-3 bg-primary">
              <div class="text-center">
                <h6 class="mb-0 text-white">Monthly Revenue</h6>
              </div>
        ...
        <div class="col-12 col-xl-5 d-flex">
          <div class="card overflow-hidden w-100">
            <div class="p-3 bg-success">
              <div class="text-center">
                <h6 class="mb-0 text-white">Yearly Income</h6>
              </div>
            ...
            <div class="card-body">
              <div class="d-flex flex-column gap-3">
                <div class="d-flex align-items-start justify-content-between">
                 ...
                 <div class="d-flex flex-column gap-3">
                  <div class="d-flex align-items-center justify-content-between">
                    <p class="mb-0 d-flex align-items-center gap-2 w-25"><span class="material-icons-outlined fs-6 text-primary">fiber_manual_record</span>Sales</p>
                    <div class="">
                      <p class="mb-0">5849</p>
                    </div>
                  </div>
                  <div class="d-flex align-items-center justify-content-between">
                    <p class="mb-0 d-flex align-items-center gap-2 w-25"><span class="material-icons-outlined fs-6 text-danger">fiber_manual_record</span>Product</p>
                    <div class="">
                      <p class="mb-0">5849</p>
                    </div>
                  </div>
                  <div class="d-flex align-items-center justify-content-between">
                    <p class="mb-0 d-flex align-items-center gap-2 w-25"><span class="material-icons-outlined fs-6 text-success">fiber_manual_record</span>Income</p>
                    <div class="">
                      <p class="mb-0">5849</p>
                    </div>
                  </div>
                  <div class="d-flex align-items-center justify-content-between">
                    <p class="mb-0 d-flex align-items-center gap-2 w-25"><span class="material-icons-outlined fs-6 text-orange">fiber_manual_record</span>Income</p>
                    <div class="">
                      <p class="mb-0">5849</p>
                    </div>
                  </div>
...
<?php include 'layouts/vendor-scripts.php'; ?>
  ...
  <script src="assets/plugins/apexchart/data-cards.js"></script>
