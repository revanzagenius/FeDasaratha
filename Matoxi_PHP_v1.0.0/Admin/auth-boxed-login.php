        ...
        <div class="card-body">
          ...
          <div class="form-body mt-4">
            <form class="row g-3">
              ...
              <div class="col-md-6 text-end"> <a href="auth-boxed-forgot-password.php">Forgot Password ?</a>
              </div>
              <div class="col-12">
                <div class="d-grid">
              ...
              <div class="col-12">
                <div class="text-start">
                  <p class="mb-0">Don't have an account yet? <a href="auth-boxed-register.php">Sign up here</a>
                  </p>
                </div>
              </div>
            </form>
