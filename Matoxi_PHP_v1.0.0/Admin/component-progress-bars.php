...
<head>
  <?php includeFileWithVariables('layouts/title-meta.php', array('title' => 'Progress Bars')); ?>
...
<?php include 'layouts/menu.php'; ?>
  ...
  <main class="main-wrapper">
    <div class="main-content">
      <!--breadcrumb-->
      <?php includeFileWithVariables('layouts/page-title.php', array('title' => 'Components', 'pagetitle' => 'Progress Bars')); ?>
