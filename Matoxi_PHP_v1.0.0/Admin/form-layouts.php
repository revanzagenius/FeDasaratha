...
<head>
  <?php includeFileWithVariables('layouts/title-meta.php', array('title' => 'Form Layouts')); ?>
...
<?php include 'layouts/menu.php'; ?>
  ...
  <main class="main-wrapper">
    <div class="main-content">
      <!--breadcrumb-->
      <?php includeFileWithVariables('layouts/page-title.php', array('title' => 'Forms', 'pagetitle' => 'Form Layouts')); ?>
                ...
                <h5 class="mb-0 text-danger">Vertical Form</h5>
							...
							<div class="card-body p-4">
								<form class="row g-3">
									...
									<div class="col-md-12">
										<div class="d-md-flex d-grid align-items-center gap-3">
											<button type="button" class="btn btn-danger px-4 rounded-0">Submit</button>
											<button type="button" class="btn btn-dark px-4 rounded-0">Reset</button>
										</div>
									</div>
								</form>
							</div>
									...
									<h5 class="mb-4">Horizontal Addon</h5>
										...
										<div class="row">
											...
											<div class="col-sm-9">
												<div class="d-md-flex d-grid align-items-center gap-3">
													<button type="button" class="btn btn-primary px-4">Submit</button>
													<button type="button" class="btn btn-dark px-4">Reset</button>
												</div>
											</div>
										</div>
									</div>
