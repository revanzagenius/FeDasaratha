<?php include 'layouts/main.php'; ?>
  <head>
  <?php includeFileWithVariables('layouts/title-meta.php', array('title' => 'Error 403')); ?>
            ...
            <div class="col-lg-12">
                <div class="text-center error-pages">
                    ...
                    <div class="mt-4 d-flex align-items-center justify-content-center gap-3">
                      <a href="index.php" class="btn btn-danger rounded-5 px-4"><i class="bi bi-house-fill me-2"></i>Go To Home</a>
