...
// Set the layout based on the debug mode
$this->layout = Configure::read('debug') ? 'dev_error' : 'error';

if (Configure::read('debug')) :
    // Assign debug variables for the error view
...
<html lang="en">
<head>
    <?= $this->element('title-meta', array('title' => 'Error 404')); ?>
            ...
            <div class="row pt-5">
                <div class="col-lg-12">
                    <div class="text-center error-pages">
                        ...
                        <p class="error-message text-white text-uppercase">SORRY, AN ERROR HAS OCCURRED, REQUESTED PAGE NOT FOUND!</p>
                        <div class="mt-4 d-flex align-items-center justify-content-center gap-3">
                            <a href="/" class="btn btn-primary rounded-5 px-4"><i class="bi bi-house-fill me-2"></i>Go To Home</a>
