              ...
              <div class="form-body mt-4">
                ...
                <?= $this->Form->create(); ?>
                  <div class="col-12">
                    ...
                    <input type="email" class="form-control" name="email" value="admin@gmail.com" id="inputEmailAddress" placeholder="jhon@example.com">
                  </div>
                  <div class="col-12">
                    <label for="inputChoosePassword" class="form-label">Password</label>
                    <div class="input-group" id="show_hide_password">
                      <input type="password" class="form-control" id="inputChoosePassword" name="password" value="123456" placeholder="Enter Password"> 
