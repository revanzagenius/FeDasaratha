<?php echo $this->render('partials/main'); ?>
  <head>
  <?php echo $this->render('partials/title-meta', array('title' => 'Error 404')); ?>
            ...
            <div class="col-lg-12">
                <div class="text-center error-pages">
                    ...
                    <div class="mt-4 d-flex align-items-center justify-content-center gap-3">
                      <a href="index" class="btn btn-primary rounded-5 px-4"><i class="bi bi-house-fill me-2"></i>Go To Home</a>
