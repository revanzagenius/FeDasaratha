...
<head>
  <?php echo $this->render('partials/title-meta', array('title' => 'Order Details')); ?>
...
<?php echo $this->render('partials/menu'); ?>
  ...
  <main class="main-wrapper">
    <div class="main-content">
      <!--breadcrumb-->
      <?php echo $this->render('partials/page-title', array( 'title' => 'eCommerce', 'pagetitle' => 'Order Details')); ?>
