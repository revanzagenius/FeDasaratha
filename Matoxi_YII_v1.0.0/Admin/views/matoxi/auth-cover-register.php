...
<head>
  <?php echo $this->render('partials/title-meta', array('title' => 'Register')); ?>
      ...
      <div class="row g-0">
        ...
        <div class="col-12 col-xl-7 col-xxl-8 auth-cover-left align-items-center justify-content-center d-none d-xl-flex border-end">
          ...
          <div class="card rounded-0 mb-0 border-0 shadow-none bg-transparent">
            <div class="card-body">
              <img src="assets/images/auth/register1.png" class="img-fluid auth-img-cover-login" width="650"
                alt="">
            </div>
          </div>
                ...
                <form class="row g-3">
                  ...
                  <div class="col-12">
                    <div class="text-start">
                      <p class="mb-0">Already have an account? <a href="auth-cover-login">Sign in here</a></p>
                    </div>
                  </div>
                </form>
              </div>
