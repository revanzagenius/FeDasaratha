...
<head>
  <?php echo $this->render('partials/title-meta', array('title' => 'Notifications')); ?>
...
<?php echo $this->render('partials/menu'); ?>
  ...
  <main class="main-wrapper">
    <div class="main-content">
      <!--breadcrumb-->
      <?php echo $this->render('partials/page-title', array( 'title' => 'Components', 'pagetitle' => 'Notifications')); ?>
