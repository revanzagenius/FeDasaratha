...
<head>
  <?php echo $this->render('partials/title-meta', array('title' => 'User Profile')); ?>
...
<?php echo $this->render('partials/menu'); ?>
  ...
  <main class="main-wrapper">
    <div class="main-content">
      <!--breadcrumb-->
      <?php echo $this->render('partials/page-title', array( 'title' => 'Pages', 'pagetitle' => 'User Profile')); ?>
            ...
            <div class="card overflow-hidden">
              <div class="card-body">
                <div class="position-relative">
                  <img src="assets/images/carousels/22.png" class="img-fluid rounded" alt="">
                  <div class="position-absolute top-100 start-50 translate-middle">
                    <img src="assets/images/avatars/06.png" width="110" height="110" class="rounded-circle raised p-1 bg-white" alt="">
                  </div>
                </div>
